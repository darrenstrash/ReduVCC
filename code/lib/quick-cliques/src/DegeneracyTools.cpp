...
NeighborList** computeDegeneracyOrderList(vector<list<int>> const &adjList, int size)
{
    ...
    long unsigned int q = 1;
    NeighborList** ordering = (NeighborList**)calloc(max(size,1), max(sizeof(NeighborList*),q));
...
NeighborListArray** computeDegeneracyOrderArray(vector<list<int>> const &adjList, int size)
{
    ...
    long unsigned int q = 1;
    NeighborListArray** orderingArray = (NeighborListArray**)calloc(max(size,1), max(sizeof(NeighborListArray*),q));
